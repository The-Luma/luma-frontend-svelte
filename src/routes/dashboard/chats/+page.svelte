...
<section class="w-full h-full card bg-surface-100-900 rounded-container overflow-hidden">
    <div class="chat w-full h-full grid grid-cols-1 lg:grid-cols-[320px_1fr]">
        <!-- Navigation -->
        <div class="h-full hidden lg:grid grid-rows-[auto_1fr] border-r-[1px] border-surface-200-800">
            <!-- Header -->
